-- Drop and Recreate Template Tables
-- This script drops all template-related tables and recreates them
...
-- Drop functions
DROP FUNCTION IF EXISTS public.can_edit_template_composition(UUID, UUID, BOOLEAN);
DROP FUNCTION IF EXISTS public.can_edit_template_fragment(UUID, UUID, BOOLEAN);
...
WHERE schemaname = 'public'
  AND tablename LIKE 'template_%'
ORDER BY tablename;

RAISE NOTICE 'Template tables have been dropped and recreated successfully!';
